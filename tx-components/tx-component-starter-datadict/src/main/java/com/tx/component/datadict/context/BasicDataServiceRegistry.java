 ...
 * <修改描述:>
 */
package com.tx.component.datadict.context;
...
import com.tx.component.datadict.model.BasicData;
import com.tx.component.datadict.model.BasicDataType;
import com.tx.component.datadict.model.DataDict;
import com.tx.component.datadict.model.TreeAbleBasicData;
import com.tx.component.datadict.service.BasicDataRemoteService;
import com.tx.component.datadict.service.BasicDataTypeService;
import com.tx.component.datadict.service.DataDictService;
import com.tx.component.datadict.service.DefaultDBBasicDataService;
import com.tx.component.datadict.service.DefaultDBTreeAbleBasicDataService;
import com.tx.component.datadict.service.DefaultRemoteBasicDataService;
import com.tx.component.datadict.service.DefaultRemoteTreeAbleBasicDataService;
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        for (Class<? extends BasicData> bdType : bdClassSet) {
            ...
            if (bdType.isAnnotationPresent(
                    com.tx.component.datadict.annotation.BasicDataType.class)
    ...
    public void initBasicDataType() {
        ...
        for (BasicDataService<? extends BasicData> s : services) {
            ...
            if (type.isAnnotationPresent(
                    com.tx.component.datadict.annotation.BasicDataType.class)) {
                com.tx.component.datadict.annotation.BasicDataType anno = type
                        .getAnnotation(
                                com.tx.component.datadict.annotation.BasicDataType.class);
                //读取注解中值
