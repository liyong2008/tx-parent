...
public class CookiePatternConverter extends LogEventPatternConverter {
    
    /** 为空时输出字符 */
    private static final String NA = "[]";
    
    protected CookiePatternConverter(final String[] options) {
        super("Cookie", "cookie");
    }
     ...
     */
    public static CookiePatternConverter newInstance(final String[] options) {
        return new CookiePatternConverter(options);
    }
